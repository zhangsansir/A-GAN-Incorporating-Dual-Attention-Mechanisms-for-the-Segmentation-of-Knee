...
from ops import conv2d,lrelu,conv2d_,deconv2d_,conv2d_1,deconv2d_my,wgan_gp_loss,BN,Context_Guided_Module,cbam_block
from utils import load_data,load_image,save_images,imread,merge,imsave,save_mat

class pix2pix_msg(object):
...
#            print('aaaaaa')
            ...
            e2_ = BN(Context_Guided_Module(lrelu(e1),self.gf_dim,name='g_cgm_e2_'),name='g_bn_2_',is_training=is_training)
            ...
            e3_ = BN(Context_Guided_Module(lrelu(e2),2*self.gf_dim,name='g_cgm_e3_'),name='g_bn_3_',is_training=is_training)
            ...
            e4_ = BN(Context_Guided_Module(lrelu(e3),4*self.gf_dim,name='g_cgm_e4_'),name='g_bn_4_',is_training=is_training)
            ...
            e5_ = BN(Context_Guided_Module(lrelu(e4),8*self.gf_dim,name='g_cgm_e5_'),name='g_bn_5_',is_training=is_training)
